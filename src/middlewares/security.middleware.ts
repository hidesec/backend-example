...
function securityHeaders(): SolumMiddleware {
    return (_req: SolumRequest, res: SolumResponse, next: SolumNext) => {
...
function cors(options: CorsOptions): SolumMiddleware {
    return (req: SolumRequest, res: SolumResponse, next: SolumNext) => {
...
function rateLimit(options: RateLimitOptions): SolumMiddleware {
